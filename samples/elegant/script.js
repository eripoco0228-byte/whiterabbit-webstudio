...
const lineBtn=document.getElementById('lineBtn');if(lineBtn){lineBtn.addEventListener('click',e=>{if(e.currentTarget.getAttribute('href')==='#'){e.preventDefault();alert('サンプルサイトです。実際の制作時に公式LINEや予約システムへ接続します。');}});}